...
(function smart404PdpRebuild() {
  ...
  (async () => {
    ...
    const triggerUrl = `https://285361-249darkllama-stage.adobeioruntime.net/api/v1/web/accs-discovery/prepublish-pdp?org=leahrayard&site=leah-bodea&path=${encodeURIComponent(lc)}`;
